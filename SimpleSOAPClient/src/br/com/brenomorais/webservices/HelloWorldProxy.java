...
public class HelloWorldProxy implements br.com.brenomorais.webservices.HelloWorld {
  private String _endpoint = null;
  private br.com.brenomorais.webservices.HelloWorld helloWorld = null;
  ...
  private void _initHelloWorldProxy() {
    try {
      helloWorld = (new br.com.brenomorais.webservices.HelloWorldServiceLocator()).getHelloWorld();
      if (helloWorld != null) {
        if (_endpoint != null)
  ...
  public br.com.brenomorais.webservices.HelloWorld getHelloWorld() {
    if (helloWorld == null)
      _initHelloWorldProxy();
    return helloWorld;
  }
