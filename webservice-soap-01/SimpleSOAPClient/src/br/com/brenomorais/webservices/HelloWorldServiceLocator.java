...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements br.com.brenomorais.webservices.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:8080/SimpleSOAP/services/HelloWorld";
    ...
    public br.com.brenomorais.webservices.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.brenomorais.webservices.HelloWorldSoapBindingStub _stub = new br.com.brenomorais.webservices.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.brenomorais.webservices.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.brenomorais.webservices.HelloWorldSoapBindingStub _stub = new br.com.brenomorais.webservices.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices.brenomorais.com.br", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices.brenomorais.com.br", "HelloWorld"));
        }
